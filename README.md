...
> *"Dados não mentem — e eu estou aqui para aprender a ouvi-los."*

🎓 Estudante de **Ciência de Dados** no **Centro Universitário de Brasília (CEUB)**  
📍 Brasília, DF  
🚀 Focado em **Python** e no início de uma jornada pela área de dados e IA  

---

## 🧠 Sobre mim

Sou apaixonado por tecnologia e inteligência artificial, e estou construindo minha base sólida em Ciência de Dados. Acredito que os dados têm o poder de transformar decisões e resolver problemas reais — e quero fazer parte disso.

Atualmente estou aprendendo:

- 🐍 **Python** — foco principal
- 📊 **Pandas & Análise de Dados**
- 🌐 **HTML & CSS** — desenvolvimento web básico
- 🗄️ **Git & GitHub** — versionamento e boas práticas
...
<!--
**vechi123/vechi123** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
